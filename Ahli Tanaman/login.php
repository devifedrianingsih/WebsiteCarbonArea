...
<body>
    <h1><a href="#" style="text-decoration: none; color: green; padding-left: 17cm; font-size: 40px;">CarbonArea</a></h1>
    <div class="main">
        <!-- Sign in Form -->
            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" action="ahli_tanaman.php" onsubmit="return redirectToAhliTanaman()" class="login-form" id="login-form">
    ...
    <script>
        ...
        document.getElementById("login-form").addEventListener("submit", function(event) {
            ...
            if (username === "" || password === "") {
                ...
                // Redirect to ahli_tanaman.php
                window.location.href = "ahli_tanaman.php";
            }
        });
    </script>
    <script>
        function redirectToAhliTanaman() {
