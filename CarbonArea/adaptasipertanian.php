        ...
        <div class="row align-items-center top-bar">
            <div style="text-align: center;">
                <a href="artikel.php" class="navbar-brand m-0 p-0">
                    <h1 class="display-3 text-green-m-0" style="color: white; font-size: xx-large;" >Adaptasi Pertanian</h1>
                </a>
            </div>
        </div>
    </div>
      ...
      <div class=>
        <nav class="navbar navbar-expand-lg navbar-light bg-white p-3 py-lg-0 px-lg-4">
            <a href="artikel.php" class="navbar-brand d-flex align-items-center m-0 p-0 d-lg-none">
                <h1 style="color: green;" >Adaptasi Pertanian</h1>
            </a>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="img/jagung (1).jpg" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4 ">
                        <h5 class=" me-3 mb-0">Adaptasi Komoditas Jagung</h5>
                        <div class="clickable-symbol" onclick="openPopup()">
                    ...
                    <div class="popup-content">
                      ...
                      <img src="img/produksijagung.jpeg" alt="Gambar Pop Up">
                        ...
                        <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <div class="d-flex align-items-center justify-content-between bg-light p-4 ">
                                <h5 class=" me-3 mb-0">Adaptasi Komoditas Sayur</h5>
                                <div class="clickable-symbol" onclick="openPopup()">
                                    <a class="btn btn-square btn-outline-primary border-2 border-light flex-shrink-0"><i class="fa fa-arrow-right"></i></a>
                                  </div>
                            </div>
                        ...
                        <div class="popup-container" id="popupContainer" onclick="closePopup()">
                            ...
                            <div class="popup-content">
                              <span class="popup-close" onclick="closePopup()">&times;</span>
                              <img src="img/adaptasisayuran.png" alt="Gambar Pop Up">
                            </div>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <div class="d-flex align-items-center justify-content-between bg-light p-4 ">
                                <h5 class=" me-3 mb-0">Adaptasi Komoditas Padi</h5>
                                <div class="clickable-symbol" onclick="openPopup()">
                                    <a class="btn btn-square btn-outline-primary border-2 border-light flex-shrink-0"><i class="fa fa-arrow-right"></i></a>
                                  </div>
                            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="img/kacang1.jpg" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4 ">
                        <h5 class=" me-3 mb-0">Adaptasi Komoditas Kacang</h5>
                        <div class="clickable-symbol" onclick="openPopup()">
                            <a class="btn btn-square btn-outline-primary border-2 border-light flex-shrink-0"><i class="fa fa-arrow-right"></i></a>
                          </div>
                    </div>
                ...
                <div class="popup-container" id="popupContainer" onclick="closePopup()">
                  ...
                  <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="img/ubi2.jpeg" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4 ">
                        <h5 class=" me-3 mb-0">Adaptasi Komoditas Ubi</h5>
                        <div class="clickable-symbol" onclick="openPopup()">
                            <a class="btn btn-square btn-outline-primary border-2 border-light flex-shrink-0"><i class="fa fa-arrow-right"></i></a>
                          </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                            <div class="overflow-hidden">
                                <img class="img-fluid w-100 h-100" src="img/kentang1.jpg" alt="">
                            </div>
                            <div class="d-flex align-items-center justify-content-between bg-light p-4 ">
                                <h5 class=" me-3 mb-0">Adaptasi Komoditas Kentang</h5>
                                <div class="clickable-symbol" onclick="openPopup()">
                                    <a class="btn btn-square btn-outline-primary border-2 border-light flex-shrink-0"><i class="fa fa-arrow-right"></i></a>
                                  </div>
                            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="img/rempah1.jpe" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4 ">
                        <h5 class=" me-3 mb-0">Adaptasi Komoditas Rempah</h5>
                        <div class="clickable-symbol" onclick="openPopup()">
                            <a class="btn btn-square btn-outline-primary border-2 border-light flex-shrink-0"><i class="fa fa-arrow-right"></i></a>
                          </div>
                    </div>
                ...
                <div class="popup-container" id="popupContainer" onclick="closePopup()">
                  ...
                  <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="img/kopi1.jpg" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4 ">
                        <h5 class=" me-3 mb-0">Adaptasi Komoditas Kopi</h5>
                        <div class="clickable-symbol" onclick="openPopup()">
                            <a class="btn btn-square btn-outline-primary border-2 border-light flex-shrink-0"><i class="fa fa-arrow-right"></i></a>
                          </div>
                    </div>
                ...
                <div class="popup-container" id="popupContainer" onclick="closePopup()">
                  ...
                  <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="img/buah1.jpg" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4 ">
                        <h5 class=" me-3 mb-0">Adaptasi Komoditas Buah</h5>
                        <div class="clickable-symbol" onclick="openPopup()">
                            <a class="btn btn-square btn-outline-primary border-2 border-light flex-shrink-0"><i class="fa fa-arrow-right"></i></a>
                          </div>
                    </div>
