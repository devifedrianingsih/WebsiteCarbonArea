...
<div class="container py-5 px-4">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white;">Data Tingkat Produksi Pertanian</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Data Tingkat Produksi Pertanian</h5>
              <!-- Table with stripped rows -->
              <table class="table datatable">
                <thead>
                  <tr>
                    <th scope="col">Komoditas Pertanian</th>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Kentang</td>
                    <td>28 November 2023</td>
                    <td>infokentang.png</td>
                  </tr>
                  <tr>
                    <td>Rempah</td>
                    <td>28 November 2023</td>
                    <td>inforempah.png</td>
                  </tr>
                  <tr>
                    <td>Kopi</td>
                    <td>28 November 2023</td>
