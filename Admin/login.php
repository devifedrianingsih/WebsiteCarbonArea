            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" action="data-kadarco2.php" onsubmit="return redirectToAdmin()" class="login-form" id="login-form">
    ...
    <script>
        ...
        document.getElementById("login-form").addEventListener("submit", function(event) {
            ...
            if (username === "" || password === "") {
                ...
                // Redirect to data-kadarco2.php
                window.location.href = "data-kadarco2.php";
            }
        });
    </script>
    <script>
