...
<div class="container py-5 px-4">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white;">Input Data Adaptasi Pertanian</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">Input Data</li>
          <li class="breadcrumb-item active">Adaptasi Pertanian</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Input Data Adaptasi Pertanian</h5>
