...
<div class="container py-5 px-4">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white;">Input Data Artikel</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Input Data Artikel</h5>
  
                <!-- General Form Elements -->
                <form>
                    <div class="row mb-3">
                        <label for="inputNumber" class="col-sm-2 col-form-label">Nomor</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Sumber</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control">
                        </div>
                    </div>
