...
<div class="container py-5 px-4">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white;">Input Data Tingkat Produksi Pertanian</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">Input Data</li>
          <li class="breadcrumb-item active">Tingkat Produksi Pertanian</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Input Data Tingkat Produksi Pertanian</h5>
  
                <!-- General Form Elements -->
                <form>
                <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Komoditas Pertanian</label>
                        <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example">
                            <option selected>Pilih Komoditas Pertanian</option>
                            <option value="1">Jagung</option>
                            <option value="2">Sayur</option>
                            <option value="3">Padi</option>
                            <option value="4">Kacang</option>
                            <option value="5">Ubi</option>
                            <option value="6">Kentang</option>
                            <option value="7">Rempah</option>
                            <option value="8">Kopi</option>
                            <option value="9">Buah</option>
                          </select>
                        </div>
                      </div>
                      <div class="row mb-3">
