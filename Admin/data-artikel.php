            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    <th scope="row">1</th>
                    <td>Upaya Penanganan Ketahanan Pangan...</td>
                    <td>https://www.ekon.go.id/publikasi/detail/3496/strategi-menjaga-ketahanan-pangan-nasional-dalam-agenda-pembangunan-nasional</td>
                    <td>ekon.go.id</td>
                  </tr>
                  <tr>
                    <th scope="row">2</th>
                    <td>Antisipasi Kemarau, Kementan Susun...</td>
                    <td>https://www.ekon.go.id/publikasi/detail/3496/strategi-menjaga-ketahanan-pangan-nasional-dalam-agenda-pembangunan-nasional</td>
                    <td>ekon.go.id</td>
                  </tr>
                  <tr>
                    <th scope="row">3</th>
                    <td>Ketahanan Pangan Untuk Kesejahteraan...</td>
                    <td>https://www.ekon.go.id/publikasi/detail/3496/strategi-menjaga-ketahanan-pangan-nasional-dalam-agenda-pembangunan-nasional</td>
                    <td>ekon.go.id</td>
                  </tr>
                  <tr>
                    <th scope="row">4</th>
                    <td>Ragam Upaya Pemprov DKI Jakarta...</td>
                    <td>https://www.ekon.go.id/publikasi/detail/3496/strategi-menjaga-ketahanan-pangan-nasional-dalam-agenda-pembangunan-nasional</td>
                    <td>ekon.go.id</td>
                  </tr>
                  <tr>
                    <th scope="row">5</th>
                    <td>Kementan Susun Strategi Ketahanan...</td>
                    <td>https://www.ekon.go.id/publikasi/detail/3496/strategi-menjaga-ketahanan-pangan-nasional-dalam-agenda-pembangunan-nasional</td>
                    <td>ekon.go.id</td>
                  </tr>
                </tbody>
